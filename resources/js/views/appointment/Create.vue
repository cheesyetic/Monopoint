                        ...
                        <div class="card">
                            <form class="card-body" method="pos" @submit.prevent="store">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="datetime-local"
                                            v-model="appointmentCreate.date">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <v-select :options="partnerOptions" @input="selectId($event, 'user_id')"
                                            v-model="appointmentCreate.user_id" multiple :disabled="partnerLoading">
                                        </v-select>
                                        <div v-if="theErrors.user_id" class="mt-1 text-danger">
                                            {{ theErrors.user_id[0] }}</div>
                                    </div>
                                </div>
                                <button class="btn btn-primary" type="submit" :disabled="requestLoading"><i
                                        class="uil-plus"></i> Buat</button>
