        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <transition tag="div" mode="out-in"
                    ...
                    leave-active-class="animate__animated animate__fadeOut animate__faster" v-if="loading"
                    class="row card p-4 col-md-6 col-xl-3">
                    <loading />
                </transition>
                <transition v-else class="row" tag="div" mode="out-in"
                            ...
                            <form class="card-body" method="post" @submit.prevent="store">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div v-if="theErrors.name" class="mt-1 text-danger">{{ theErrors.name[0] }}
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div v-if="theErrors.date" class="mt-1 text-danger">{{ theErrors.date[0] }}
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div v-if="theErrors.remark" class="mt-1 text-danger">{{ theErrors.remark[0] }}
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <v-select :options="partnerOptions" v-model="partnerSelected" multiple
                                            :disabled="partnerLoading"></v-select>
                                        <div v-if="theErrors.user_id" class="mt-1 text-danger">
                                            {{ theErrors.user_id[0] }}</div>
                                    </div>
                                </div>
                                <button class="btn btn-primary" type="submit" :disabled="loadingCRUD"><i
        ...
        methods: {
            ...
            async findAppointment() {
                ...
                if (response.status === 200) {
                    ...
                    this.appointment.date = moment(String(this.appointment.date)).format('yyyy-MM-DD') + 'T' +
                        moment(String(this.appointment.date)).format('hh:mm:ss')
            ...
            async store() {
                ...
                try {
                    let response = await axios.post('/api/appointment/' + this.$route.params.token, this
                        .appointment, {
                            headers: {
                                'Authorization': 'Bearer ' + this.auth.token
                            }
